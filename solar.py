#!/home/user/tracer_sql/venv/bin/python3
...
engine = create_engine('sqlite:////home/user/tracer_sql/solar.sqlite')
...
parameters = open("/home/user/tracer_sql/parameters.txt", "w")
for p in p:
